 ...
 *     description: Only admins can create other restaurants.
 *     tags: [Restaurants]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Only admins can retrieve all restaurants.
 *     tags: [Restaurants]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in restaurants can fetch only their own restaurant information. Only admins can fetch other restaurants.
 *     tags: [Restaurants]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in restaurants can only update their own information. Only admins can update other restaurants.
 *     tags: [Restaurants]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in restaurants can delete only themselves. Only admins can delete other restaurants.
 *     tags: [Restaurants]
 *     security:
 *       - bearerAuth: []
 *     parameters:
